...
btn_minu = tk.Button(root, text="-", command=lambda: add_to_calculation("-"), width=5, font=("Arial", 14))
btn_minu.grid(row=3, column=4)
...
btn_cr = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial", 14))
btn_cr.grid(row=5, column=3)

btn_clear = tk.Button(root, text="C", command=clear_field, width=10, font=("Arial", 14))
btn_clear.grid(row=6, column=1, columnspan=2)

btn_res = tk.Button(root, text="=", command=evaluate_calculation, width=10, font=("Arial", 14))
